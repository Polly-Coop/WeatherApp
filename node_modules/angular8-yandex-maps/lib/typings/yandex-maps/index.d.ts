...
declare namespace ymaps {
    ...
    type ControlSingleKey = 'fullscreenControl' | 'geolocationControl' | 'routeEditor' | 'rulerControl' | 'searchControl' | 'trafficControl' | 'typeSelector' | 'zoomControl' | 'routeButtonControl' | 'routePanelControl';
    ...
    namespace geometry {
        ...
        class Circle implements ICircleGeometry {
            constructor(coordinates?: number[] | null, radius?: number, options?: {
                geodesic?: boolean;
        ...
        class Rectangle implements IRectangleGeometry {
            constructor(coordinates?: number[][] | null, options?: {
    ...
    namespace geometryEditor {
        ...
        class Point implements IGeometryEditor {
            constructor(geometry: IPointGeometry, options?: {
    ...
    namespace layout {
        ...
        type IImageWithContentOptionsWithIconPrefix = Prefix<IImageOptions & {
    ...
    namespace panorama {
        ...
        class Base implements IPanorama {
            ...
            static getMarkerPositionFromDirection(panorama: IPanorama, direction: number[], distance: number): number[];
        ...
        function locate(point: number[], options?: {
            layer?: Layer;
        }): Promise<IPanorama[]>;
        class Manager implements IEventEmitter {
            events: IEventManager;
    ...
    namespace shape {
        class Circle implements IShape {
            constructor(pixelGeometry: IPixelCircleGeometry, params?: {
                fill?: boolean;
                outline?: boolean;
                strokeWidth?: number;
            });
        ...
        class LineString implements IShape {
            constructor(pixelGeometry: IPixelLineStringGeometry, params?: {
                strokeWidth?: number;
            });
            contains(position: number[]): boolean;
            equals(shape: IShape): boolean;
        ...
        class MultiPolygon implements IShape {
            constructor(pixelGeometry: IPixelMultiPolygonGeometry, params?: {
                fill?: boolean;
                outline?: boolean;
                strokeWidth?: number;
            });
        ...
        class Polygon implements IShape {
            constructor(pixelGeometry: IPixelPolygonGeometry, params?: {
                fill?: boolean;
                outline?: boolean;
                strokeWidth?: number;
            });
        ...
        class Rectangle implements IShape {
            constructor(geometry: IPixelRectangleGeometry, params?: {
                fill?: boolean;
                outline?: boolean;
                strokeWidth?: number;
            });
    ...
    interface IClustererOptions extends IClustererOptionsInject, IClusterPlacemarkOptionsWithClusterPrefix {
    ...
    class Event<OriginalEvent = object, TargetGeometry = object> implements IEvent<OriginalEvent, TargetGeometry> {
    ...
    class DomEvent<OriginalEvent = object, TargetGeometry = object> implements IDomEvent<OriginalEvent, TargetGeometry> {
    ...
    class Layer implements ILayer, IParentOnMap, IPositioningContext {
        constructor(tileUrlTemplate: string | ((tileNumber: number[], tileZoom: number) => string), options?: ILayerOptions);
        events: IEventManager;
        options: IOptionManager;
    ...
    class Map implements IDomEventEmitter {
        ...
        setGlobalPixelCenter(globalPixelCenter: number[], zoom?: number, options?: IMapPositionOptions): this;
        setType(type: string | MapType, options?: IMapCheckZoomRangeOptions): this;
        setZoom(zoom: number, options?: IMapZoomOptions): this;
    }
    class MapEvent<OriginalEvent = object, TargetGeometry = object> extends Event<OriginalEvent, TargetGeometry> {
        get(name: string): any;
    ...
    class Placemark extends GeoObject<IPointGeometry, geometry.Point> {
        constructor(geometry: number[] | object | IPointGeometry, properties?: IPlacemarkProperties | IDataManager, options?: IPlacemarkOptions);
    }
    ...
    interface IPlacemarkOptions extends layout.IImageOptionsWithIconPrefix, layout.IImageWithContentOptionsWithIconPrefix, layout.IPieChartOptionsWithIconPrefix, IBalloonOptionsWithBalloonPrefix, IHintOptionsWithHintPrefix {
        cursor?: string;
        draggable?: boolean;
        hasBalloon?: boolean;
        hasHint?: boolean;
    ...
    interface IRectangleOptions extends IBalloonOptionsWithBalloonPrefix, IHintOptionsWithHintPrefix {
        ...
        outline?: boolean;
        pane?: string;
        rectangleOverlay?: OverlayKey | ((geometry: IPixelCircleGeometry, data: IDataManager | object, options: object) => vow.Promise);
        strokeColor?: string | string[];
        strokeOpacity?: number | number[];
        strokeStyle?: string | string[] | object | object[];
        strokeWidth?: number | number[];
    ...
    class Rectangle extends GeoObject<ILineStringGeometry> {
        constructor(geometry: number[][] | object | IRectangleGeometry, properties?: IRectangleProperties | IDataManager, options?: IRectangleOptions);
    }
    namespace regions {
        function load(region: string, options?: {
    ...
    namespace templateLayoutFactory {
        function createClass<O extends object = object, S extends object = object>(template: string, overrides?: O, staticMethods?: S): IClassConstructor<layout.templateBased.Base & O & S>;
    }
    ...
    namespace util {
        class AsyncStorage extends Storage {
            define(key: string, depends: string[], resolveCallback: ResolveCallbackFunction, context?: object): this;
            define(key: string, resolveCallback: ResolveCallbackFunction, context?: object): this;
            isDefined(key: string): boolean;
            require(keys: string | string[], successCallback?: (...args: any[]) => void, errorCallback?: (error: any) => void, context?: object): vow.Promise;
        }
        function augment(ChildClass: any, ParentClass: any, override: object): any;
        function bind(callback: any, context: object): any;
        const bounds: {
            areIntersecting(bounds1: number[][], bounds2: number[][], projection?: typeof ymaps.projection.wgs84Mercator): boolean;
            containsBounds(outer: number[][], inner: number[][], projection?: typeof ymaps.projection.wgs84Mercator): boolean;
            containsPoint(bounds: number[][], point: number[], projection?: typeof ymaps.projection.wgs84Mercator): boolean;
            fromBounds(sourceBounds: number[][], projection?: typeof ymaps.projection.wgs84Mercator): number[][];
            fromGlobalPixelBounds(pixelBounds: number[][], zoom: number, projection?: typeof ymaps.projection.wgs84Mercator): number[][];
            fromPoints(points: number[][], projection?: typeof ymaps.projection.wgs84Mercator): number[][];
            getCenter(bounds: number[][], projection?: typeof ymaps.projection.wgs84Mercator): number[];
            getCenterAndZoom(bounds: number[][], containerSize: number[], projection?: typeof ymaps.projection.wgs84Mercator, params?: {
                inscribe?: boolean;
                margin?: number | number[];
                preciseZoom?: boolean;
            }): object;
            getIntersections(bounds1: number[][], bounds2: number[][], projection?: typeof ymaps.projection.wgs84Mercator): number[][][];
            getSize(bounds: number[][], projection?: typeof ymaps.projection.wgs84Mercator): number[];
            toGlobalPixelBounds(geoBounds: number[][], zoom: number[], projection?: typeof ymaps.projection.wgs84Mercator): number[][];
        };
        namespace cursor {
            class Accessor {
        ...
        function requireCenterAndZoom(mapType: string | MapType | map.ZoomRange, bounds: number[][], containerSize: number[], params?: {
            inscribe?: boolean;
            margin?: number | number[];
            preciseZoom?: boolean;
        }): vow.Promise;
    ...
    namespace vow {
        ...
        class Promise {
            ...
            done(onFulfilled?: (...args: any[]) => void, onRejected?: (err?: Error | any) => void, onProgress?: (...args: any[]) => void, ctx?: object): void;
            spread(onFulfilled?: (...args: any[]) => void, onRejected?: (err?: Error | any) => void, ctx?: object): vow.Promise;
            then(onFulfilled?: (...args: any[]) => void, onRejected?: (err?: Error | any) => void, onProgress?: (...args: any[]) => void, ctx?: object): vow.Promise;
            valueOf(): object;
        }
    ...
    interface IDomEvent<OriginalEvent = object, TargetGeometry = object> extends IEvent<OriginalEvent, TargetGeometry> {
        getSourceEvent(): IDomEvent<OriginalEvent, TargetGeometry>;
    }
    ...
    type IGeoQuerySource = IGeoObject | IGeoObject[] | ICollection | ICollection[] | IPromiseProvider | vow.Promise | GeoQueryResult | string | object | object[];
    class GeoQueryResult implements IPromiseProvider {
        ...
        applyBoundsToMap(map: Map, options?: {
            checkZoomRange?: boolean;
            duration?: number;
            preciseZoom?: boolean;
            timingFUnction?: string;
        ...
        remove(objects: IGeoObject | IGeoObject[] | ICollection | ICollection[] | this | vow.Promise | any): this;
        ...
        searchContaining(object: IGeoObject | IGeometry | Map | number[] | number[][] | object | any): this;
        searchInside(object: IGeoObject | IGeometry | Map | any): this;
        searchIntersect(object: IGeoObject | IGeometry | Map | any, options?: {
            considerOccurance?: boolean;
        }): this;
        ...
        sortByDistance(object: IGeoObject | IGeometry | Map | number[] | number[][] | object | any): this;
    ...
    interface IObjectManagerOptions extends Omit<IClustererOptionsInject, 'hasBalloon' | 'hasHint'>, IClusterPlacemarkOptionsWithClusterPrefix, Omit<IGeoObjectOptionsWithGeoObjectPrefix, 'visible'> {
    ...
    interface ILoadingObjectManagerOptions extends Omit<IClustererOptionsInject, 'hasBalloon' | 'hasHint'>, IClusterPlacemarkOptionsWithClusterPrefix, Omit<IGeoObjectOptionsWithGeoObjectPrefix, 'visible'> {
        clusterize?: boolean;
        loadTileSize?: number;
    ...
    namespace modules {
        ...
        function require(modules: string | string[], successCallback?: (...args: any[]) => void, errorCallback?: (error: any) => void, context?: object): vow.Promise;
    }
    interface IHotspotObjectSource extends ICustomizable, IEventEmitter {
        cancelLastRequest(): void;
        requestObjects(layer: hotspot.Layer, tileNumber: number[], zoom: number, callback: () => void): void;
    }
    interface IHotspotLayerOptions extends IBalloonOptionsWithBalloonPrefix, IHintOptionsWithHintPrefix {
        cursor?: string;
    ...
    namespace hotspot {
        ...
        class ObjectSource implements IHotspotObjectSource {
            constructor(tileUrlTemplate: string | ((tileNumber: number[], tileZoom: number) => string), keyTemplate?: string | ((tileNumber: number[], tileZoom: number) => string), options?: {
                bounds?: number[][];
                maxZoom?: number;
                minZoom?: number;
                noCache?: boolean;
            ...
            parseResponse(layer: hotspot.Layer, res: object, callback: () => void, tileNumber: number[], zoom: number): void;
            requestObjects(layer: hotspot.Layer, tileNumber: number[], zoom: number, callback: () => void): void;
    ...
    namespace geolocation {
        ...
        function get(options?: IGeolocationOptions): Promise<{
            geoObjects: GeoObjectCollection;
        }>;
    }
    interface ISuggestProvider {
